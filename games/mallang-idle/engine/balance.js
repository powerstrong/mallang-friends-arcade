...
(function (root, factory) {
  ...
  var BALANCE = {
    ...
    /* 도입 첫 벽 (codex 재미 리뷰 #1) — 자연 곡선의 첫 실패는 5분 밖(8~9층)에서
     * 온다. 즉 P1 게이트가 검증하려는 "막힘 → 강화 → 돌파" 루프를 첫 세션이
     * 경험하지 못한다. 6층 보스만 의도적으로 굵게 만들어 ~3분에 첫 벽을 놓는다.
     * 값은 시뮬로 맞춤: 첫 실패 후 강화 한두 번이면 다음 도전에 뚫리는 두께. */
    firstWallStage: 5,
    firstWallHpMul: 1.3,
