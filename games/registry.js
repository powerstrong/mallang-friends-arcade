...
window.GAME_REGISTRY = [
  ...
  },
  {
    id: 'mallang-idle',
    title: '말랑프렌즈 키우기',
    description: '말랑친구가 알아서 몬스터를 물리쳐요. 짬짬이 들러 강화하고 보스를 돌파하는 방치형 RPG 🐰',
    type: 'SOLO',
    recommendedPlayers: '1명',
    supportedPlayers: '1명',
    playMode: '방치형 · 세로 싱글플레이',
    durationSeconds: 0,
    status: 'DRAFT',
    visibility: 'DIRECT_ONLY',
    reviewState: 'NOT_SUBMITTED',
    ...
    resultScale: 1,
    resultDecimals: 0,
    path: '/games/mallang-idle/index.html',
  },
  {
  ...
  },
  {
    id: 'choice-holdem',
    title: '초이스 홀덤',
    description: '선플레이어는 두 장을 다 보고 한 장만 공개 — 확실한 카드와 미지의 카드 중 하나를 고르는 심리전 포커 🃏',
    type: 'DUEL_LIVE',
    recommendedPlayers: '1~2명',
    supportedPlayers: '1~2명',
    playMode: '혼자는 말랑봇 · 같이하기는 온라인 1:1',
    durationSeconds: 0,
    status: 'DRAFT',
    visibility: 'DIRECT_ONLY',
    reviewState: 'NOT_SUBMITTED',
    ...
    resultScale: 1,
    resultDecimals: 0,
    path: '/games/choice-holdem/index.html',
  },
];
