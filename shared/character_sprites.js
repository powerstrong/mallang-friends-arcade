 ...
 * existing identifiers (jump-climber already uses kebab-case).
 */
...
window.CHARACTERS = [
  {
    ...
    gameIds: { 'jump-climber': 'latte-puppy', 'sseuk-sseuk': 'latte-puppy' },
  },
  {
    ...
    gameIds: { 'jump-climber': 'mochi-rabbit', 'sseuk-sseuk': 'mochi-rabbit' },
  },
  {
    ...
    gameIds: { 'jump-climber': 'pudding-hamster', 'sseuk-sseuk': 'pudding-hamster' },
  },
  {
    worldId: 'mint_kitten',
    label: '민트 고양이',
    ...
    gameIds: { 'jump-climber': 'mint-kitten', 'sseuk-sseuk': 'mint-kitten' },
  },
  {
    worldId: 'peach_chick',
    label: '말랑 병아리',
    ...
    gameIds: { 'jump-climber': 'peach-chick', 'sseuk-sseuk': 'peach-chick' },
  },
];
